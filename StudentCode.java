...
public class StudentCode extends Server{
    ...
    public void handleClick(String country) {
        ...
        sendMessageToUser("Total population of countries: " + grapher.getCountries().get(country).getPopulation());
        */
        //if country doesn't exist, it will say so + pop=0. If country is island + does exist, it will break
        long total = 0;
        ...
        for(Country n : neighbors){
            ...
            if(grapher.getPopulations().get(n)==null) System.out.println(n + " is a null population");
